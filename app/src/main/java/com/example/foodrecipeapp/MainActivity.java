...
import java.util.List;
 ...
 public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemClickListener((AdapterView.OnItemClickListener) spinnerSelectedListener);
     ...
     private final RecipeClickListner recipeClickListner = new RecipeClickListner() {  //interface
         @Override
         public void onRecipeClicked(String id) {

           startActivity(new Intent(MainActivity.this, RecipeDetailsActivity.class)
                   .putExtra("id",id)); //pass id MainActivity to RecipeDetailsActivity
